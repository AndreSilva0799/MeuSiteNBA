document.addEventListener("DOMContentLoaded", function () {
    ...
    loginButton.addEventListener("click", function (e) {
        ...
        const password = document.querySelector('input[name="password"]').value;    // Verificar se o email e a senha correspondem aos valores desejados
        if (email === "andrevictor2102@hotmail.com" && password === "210215")
        {  
            alert("Login efetuado com sucesso voltando para pagina Home")
